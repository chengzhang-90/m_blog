...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIfjg2Tn0CvHeL"; // AccessKeyId

        $accessKeySecret = "NG56ajfyakudZZT1kWEXSOlkuxSIHz"; // AccessKeySecret
    ...
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("杂货店");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_133270201");
    ...
    public function get_sms($phone,$code){
        // 调用示例：
        set_time_limit(0);
